...
rmse_ihepc_fnn_te = rmse_1(te_value, fnn_te_pre)
figure()
...
te_value = active_power(te_index)';
rmse_ihepc_elm_te = rmse_1(te_value, elm_te_pre)
figure()
...
te_value = active_power(te_index)';
rmse_ihepc_rbf_te = rmse_1(te_value, rbf_te_pre)
figure()
...
ihepc_rmse = rmse_1(te_value, ensemble_fore) 
...
save('case1_ihepc_trim_agg.mat','ensemble_fore')
...
rmse_aep_fnn_te = rmse_1(te_value, fnn_te_pre)
figure()
plot(time(te_index), fnn_te_pre, 'b')
hold on
plot(time(te_index), te_value, 'r')
...
te_value = series_data(te_index, 1)';
rmse_aep_elm_te = rmse_1(elm_te_pre, te_value)
...
te_value = series_data(te_index, 1)';
rmse_aep_rbf_te = rmse_1(te_value, rbf_te_pre)
figure()
plot(time(te_index), rbf_te_pre, 'b')
hold on
plot(time(te_index), te_value, 'r')
...
ape_rmse = rmse_1(te_value, ensemble_fore)
...
save('case1_aep_trim_agg.mat','ensemble_fore')
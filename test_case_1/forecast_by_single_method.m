...
save('case1_ihepc_lstm_forecast.mat','y_lstm');
...
% save('case1_ihepc_gpr_forecast.mat','y_gpr');
% 
% %% var model
% Mdl = varm(1, 20);
% for i = te_index(1):1:te_index(end)
...
% legend('forecast data', 'true data')
% save('case1_ihepc_var_forecast.mat','y_var');
...
legend('forecast', 'true')
save('case1_aep_lstm_forecast.mat','y_lstm');
...
% save('case1_aep_gpr_forecast.mat','y_gpr');
% 
% figure()
% plot(time(te_index), y_gpr,'b')
% hold on
...
% save('case1_aep_var_forecast.mat','y_var')
% figure()
% plot(time(te_index), y_var,'b')
% hold on
% plot(time(te_index), true_value,'r')

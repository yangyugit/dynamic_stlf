...
figure()
plot(time(te_index(1:60:end)), true_value(1:60:end), '-', 'LineWidth', 1.5, 'color', [255, 0, 0]./255)
hold on 
plot(time(te_index(1:60:end)), noise_value(1:60:end), '-', 'LineWidth', 1.5, 'color', [0, 0, 255]./255)
legend('true value', 'with noise')
set(gca,'FontSize',20);
set(gcf,'position',[5 5 1600 600])
print(gcf,'test2a','-dpng','-r600')
...
figure()
plot(time(time_index1), true_value(value_index1), '-', 'LineWidth', 1.5, 'color', [255, 0, 0]./255)
hold on 
...
figure()
plot(time(time_index2), true_value(value_index2), '-', 'LineWidth', 1.5, 'color', [255, 0, 0]./255)
hold on 
...
set(gca,'FontSize',20);
set(gcf,'position',[5 5 600 400])
print(gcf,'test21c','-dpng','-r600')

% % =========================================================================
clear all
load test_case2_aep.mat
...
figure()
plot(time(te_index(1:6:end)), true_value(1:6:end), '-', 'LineWidth', 1.5, 'color', [255, 0, 0]./255)
hold on 
plot(time(te_index(1:6:end)), noise_value(1:6:end), '-', 'LineWidth', 1.5, 'color', [0, 0, 255]./255)
legend('true value', 'with noise')
set(gca,'FontSize',20);
set(gcf,'position',[5 5 1600 600])
print(gcf,'test2b','-dpng','-r600')
...
value_index1 = [(true_value(1)+3*24*6+ 7*6):1: (true_value(1)+3*24*6 + 7*6+ 5*6)];
figure()
plot(time(time_index1), true_value(value_index1), '-', 'LineWidth', 1.5, 'color', [255, 0, 0]./255)
hold on 
plot(time(time_index1), t_static(value_index1), 'o-', 'LineWidth', 1.5,  'color', [0, 255, 0]./255)
...
value_index1 = [(true_value(1)+5*24*6+ 12*6):1: (true_value(1)+5*24*6 + 12*6+ 5*6)];
figure()
plot(time(time_index1), true_value(value_index1), '-', 'LineWidth', 1.5, 'color', [255, 0, 0]./255)
hold on 
plot(time(time_index1), t_static(value_index1), 'o-', 'LineWidth', 1.5,  'color', [0, 255, 0]./255)
